...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/quiet-bush-0ce9)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/quiet-bush-0ce9
```

A live public deployment of this template is available at [https://quiet-bush-0ce9.templates.workers.dev](https://quiet-bush-0ce9.templates.workers.dev)
